...
export function ProductDetailClient({ product, consultant }: ProductDetailClientProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 min-h-screen text-slate-900 dark:text-slate-100 flex justify-center">
            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-900 min-h-screen relative pb-32 shadow-2xl">
                {/* Header */}
                ...
                <main className="mt-16">
                    ...
                    <div className="relative bg-gradient-to-b from-orange-50 to-white dark:from-slate-800 dark:to-slate-900 px-4 pt-8 pb-12 overflow-hidden">
                        ...
                        {isPromo && (
                            <div className="absolute bottom-6 right-6 bg-white dark:bg-slate-800 p-3 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 flex flex-col items-center z-20">
                                <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Ahorras</span>
                    ...
                    <div className="px-6 -mt-8 relative z-20">
                        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-lg border border-slate-100 dark:border-slate-800">
                            ...
                            {/* Upsell (Static from HTML) */}
                            <div className="mt-8 p-4 bg-orange-50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-900/20 rounded-2xl flex items-center gap-4">
                                <div className="bg-orange-500 p-2 rounded-xl text-white">
                                    <Gift className="w-5 h-5" />
                                </div>
                                <div>
                                    <p className="text-xs font-semibold text-orange-600 uppercase">Opcional</p>
                                    <p className="text-sm text-slate-800 dark:text-slate-200">
                                        Suma una <b>bolsa de regalo</b> en el checkout.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="fixed bottom-0 w-full max-w-md p-4 bg-white/95 dark:bg-black/95 backdrop-blur-md border-t border-gray-100 dark:border-gray-800 z-50 flex gap-3">
                    ...
                    <button
                        ...
                        className="flex-1 bg-green-500 hover:bg-green-600 text-white py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-95 text-sm font-bold"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-95 text-sm font-bold disabled:opacity-50 disabled:grayscale"
                    >
                        {isPending ? 'Agregando...' : (
                            <>
